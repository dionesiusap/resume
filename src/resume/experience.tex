...
%---------------------------------------------------------
%    \cventry
%    {Programming Team Advisor} % Job title
%    {Dagozilla ITB Robotics} % Organization
%    {Bandung, Indonesia} % Location
%    {Sept 2019 - Present} % Date(s)
%    {
%        \begin{cvitems} % Description(s) of tasks/responsibilities
%            \item {Gives techical advises and feedbacks to the programming team.}
%            \item {Helps in the implementation of some simple softwares.}
%        \end{cvitems}
%    }
